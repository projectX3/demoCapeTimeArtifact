...
taskManagerModule.controller('taskManagerController', function ($scope,$http) {
    ...
    function findAllTodos() {
        ...
        $http.get(urlBase + '/todoes/search/findByTblstatus?statusID=1').
//        $http.get(urlBase + '/todoes/search/findByTitle?title=MyFirstTodo').
        		//ByTitle?title="myFirstTodo"').
...
//                    if ($scope.todos[i].todoStatus == 'COMPLETED') {
//                        $scope.selection.push($scope.todos[i].todoId);
//                    }
//                }
                $scope.todoName="";
                $scope.todoDesc="";
